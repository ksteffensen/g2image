<?php
$gallery_path = $_REQUEST['g2_path'];
$album_id = $_REQUEST['g2_album_id'];
?>
...
<body>
	...
	<script type="text/javascript">
		...
		fo.addVariable("xmlDataPath", "<?php echo $gallery_path; ?>main.php?g2_view=simpleviewersource.XMLOut%26g2_itemId=<?php echo $album_id; ?>");

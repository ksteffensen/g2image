...
// 'link_image', 'link_parent', 'drupal_g2_filter', 'thumbnail_lightbox',
...
// 'title_desc', 'mtime_desc' (modification time, newest first), 'mtime_asc'
// (modification time, oldest first), 'orig_time_desc' (origination time,
// newest first), and 'orig_time_asc' (origination time, oldest first)
